...
function [Des,Des_Props_Hull,Des_Props_Wing,HullCoords] = AUVCase(HullLength,HullDia,TurbDia)
...
ShuttleDistance = 60000; % m (from a point in the GS to the Ship parked at the edge of the GS)
